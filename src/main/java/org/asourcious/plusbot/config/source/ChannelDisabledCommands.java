...
public class ChannelDisabledCommands extends DataSource<String> {
    ...
    public ChannelDisabledCommands(HikariDataSource connectionPool, ExecutorService executorService) throws SQLException {
        super(connectionPool, executorService, Constants.CHANNEL_DISABLED_COMMANDS);
